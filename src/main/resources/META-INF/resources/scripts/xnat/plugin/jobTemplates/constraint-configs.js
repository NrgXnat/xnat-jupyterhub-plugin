...
XNAT.plugin.jobTemplates.constraintConfigs = getObject(XNAT.plugin.jobTemplates.constraintConfigs || {});
...
(function (factory) {
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.get = async (id) => {
        console.debug(`Fetching constraint config ${id}`);
        const url = XNAT.url.restUrl(`/xapi/job-templates/constraint-configs/${id}`);
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.getAll = async () => {
        console.debug('Fetching all constraint configs');
        const url = XNAT.url.restUrl('/xapi/job-templates/constraint-configs');
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.create = async (constraintConfig) => {
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.update = async (constraintConfig) => {
        console.debug(`Updating constraint config ${constraintConfig.id}`);
        const url = XNAT.url.restUrl(`/xapi/job-templates/constraint-configs/${constraintConfig.id}`);
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.delete = async (id) => {
    ...
    XNAT.plugin.jobTemplates.constraintConfigs.save = async (constraintConfig) => {
        console.debug(`Saving constraint config ${constraintConfig.id}`);
        if (constraintConfig.id) {
            return XNAT.plugin.jobTemplates.constraintConfigs.update(constraintConfig);
        } else {
            return XNAT.plugin.jobTemplates.constraintConfigs.create(constraintConfig);
        }
    }
    
    XNAT.plugin.jobTemplates.constraintConfigs.manager = async (containerId) => {
        ...
        const deleteConfig = (id) => {
            XNAT.plugin.jobTemplates.constraintConfigs.delete(id).then(() => {
        ...
        const enabledToggle = (config) => {
            ...
            let ckbox = spawn('input', {
                ...
                onchange: () => {
                    ...
                    XNAT.plugin.jobTemplates.constraintConfigs.update(config).then(() => {
                ...
                buttons: [
                    {
                        ...
                        action: function () {
                            ...
                            XNAT.plugin.jobTemplates.constraintConfigs.save(config).then(() => {
        ...
        const refreshTable = () => {
            XNAT.plugin.jobTemplates.constraintConfigs.getAll().then(data => {
