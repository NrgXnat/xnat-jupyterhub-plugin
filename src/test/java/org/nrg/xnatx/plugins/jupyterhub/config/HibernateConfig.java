...
public class HibernateConfig {
    ...
    public Properties hibernateProperties() throws IOException {
        ...
        // H2 2.x (from the XNAT 1.10 BOM) rejects DDL generated by HSQLDialect,
        // so the old HHH-13711 workaround (fixed in Hibernate 5.4) no longer applies.
    ...
    public DataSource dataSource() {
        ...
        // NON_KEYWORDS: the compute entities from xnat-web use "key"/"value" as
        // column names, which are reserved words in H2 2.x
        basicDataSource.setUrl("jdbc:h2:mem:test;DB_CLOSE_DELAY=-1;DB_CLOSE_ON_EXIT=FALSE;NON_KEYWORDS=KEY,VALUE");
