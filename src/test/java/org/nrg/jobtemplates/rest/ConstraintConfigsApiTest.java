...
import org.nrg.jobtemplates.config.ConstraintConfigsApiTestConfig;
...
public class ConstraintConfigsApiTest {
    ...
    public void testGetPlacementConstraintConfig() throws Exception {
        ...
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .get("/job-templates/constraint-configs/1")
    ...
    public void testGetAllPlacementConstraintConfigs() throws Exception {
        // Set up the request
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .get("/job-templates/constraint-configs")
                .with(authentication(mockAuthentication))
                .with(csrf())
                .with(testSecurityContext());
        // Make the call
    ...
    public void testCreatePlacementConstraintConfig() throws Exception {
        // Set up the request
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .post("/job-templates/constraint-configs")
    ...
    public void testUpdatePlacementConstraintConfig() throws Exception {
        // Set up the request
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .put("/job-templates/constraint-configs/1")
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON)
                .with(authentication(mockAuthentication))
                .with(csrf())
    ...
    public void testUpdatePlacementConstraintConfig_IdMismatch() throws Exception {
        // Set up the request
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .put("/job-templates/constraint-configs/2")
                .contentType(APPLICATION_JSON)
                .accept(APPLICATION_JSON)
                .with(authentication(mockAuthentication))
                .with(csrf())
    ...
    public void testDeletePlacementConstraintConfig() throws Exception {
        // Set up the request
        final MockHttpServletRequestBuilder request = MockMvcRequestBuilders
                .delete("/job-templates/constraint-configs/1")
                .with(authentication(mockAuthentication))
                .with(csrf())
                .with(testSecurityContext());
